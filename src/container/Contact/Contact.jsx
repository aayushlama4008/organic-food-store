...
import questions from "./Contact.js";
const Contact = () => {
  return (
    <div className="app__contact">
      ...
      <section className="app__contact-details ">
        ...
        <div className="app__contact-details-main">
          <div className="app__contact-number  links grid-center ">
            <icons.phone className="icon-contact" size={23} />
            <a href="tel:+39 390 390 3909">+39 390 390 3909</a>
            <a href="tel:+39 390 390 3909">+39 390 390 3909</a>
          </div>
          <div className="app__contact-email links grid-center">
          ...
          <div className="app__contact-location links grid-center">
